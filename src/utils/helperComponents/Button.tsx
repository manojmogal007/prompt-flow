...
const colors: Record<string, { solid: string; hollow: string }> = {
  ...
  amber: {
    solid: 'bg-amber-600 hover:bg-amber-700 text-white shadow-amber-500/20',
    hollow: 'text-amber-600 border-amber-200 hover:bg-amber-50 dark:border-amber-800 dark:hover:bg-amber-900/30',
  },
};
