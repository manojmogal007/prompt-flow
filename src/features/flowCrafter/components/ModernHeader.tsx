        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-3'>
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${showPreview
            ...
            <button
              onClick={toggleRun}
              className={`flex items-center space-x-2 px-4 py-1.5 rounded-lg font-medium transition-colors ${isRunning
